...
public abstract class MarkerUnit implements AttackMarkerInterface{
	...
	MarkerUnit(String name, int hp, int atk, int def, int pos) {
		this.name = name;
		this.hp = hp;
		this.atk = atk;
		this.def = def;
	...
	public void attack(AttackMarkerInterface attackUnit) {
		MarkerUnit target = (MarkerUnit) attackUnit;
